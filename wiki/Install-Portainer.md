...
|---|---|---|
| `latest` | `trek:local` | Always the newest release across all major versions |
| Major version | `trek:local` | Latest release pinned to that major version |
| Full version | `trek:local` | Exact release; never changes |
